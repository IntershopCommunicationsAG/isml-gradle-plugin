...
|*jspCompilerVersion*     |`String` | '11.0.11'      | The version of JSP compiler.
|*ismlCompilerVersion*     |`String` | '13.0.0'      | The version of ISML compiler.
|*sourceSetName*      |`String` | 'main'        | Name of the Java source set, which can be used for ISML compilation.
|*jspConfigurationName*  |`String` | 'runtimeClasspath'     | Name of the configuration, which is used for the classpath of JSP compilation.
|*sourceCompatibility*  |`String` | '21' | This Java source compatibility is used for the compilation of java files.
|*targetCompatibility*  |`String` | '21' | This Java target compatibility is used for the compilation of java files.
...
|*jspPackage* | `String` | 'org.apache.jsp.<project&nbsp;name>  | The package name of the compiled JSP files.
|*taskName*     | `String` | 'isml'                                  | The task name.
|===
